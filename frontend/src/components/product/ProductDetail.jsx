...
import { getSingleProductLink } from '../../api_calls/productApi';
...
const ProductDetail = () =>
{
  ...
  useEffect(() => {
    ...
    const getSingleProduct = async () => {
      try {
        const response = await axios.get(`http://localhost:5000/api/product/getsingleproduct/${productId}`);
    ...
    getSingleProduct(); // Call getSingleProduct here
  }, [data, productId]); // Include data and productId in the dependency array
            ...
            <div className="w-full px-4 md:w-1/2 ">
              <div className="lg:pl-20">
                <div className="mb-8 ">
                  ...
                  <h2 className="max-w-xl mt-2 mb-6 text-2xl font-bold dark:text-gray-400 md:text-4xl h-[50px]">
                    {product?.name}
                  </h2>
                  ...
                  <p className="mb-8 text-4xl font-bold text-gray-700 dark:text-gray-400 h-[50px]">
                    <span>${product?.price}</span>
                    <span className="text-base font-normal mb-3 text-gray-500 line-through dark:text-gray-400">
                      ${product?.price}
                    </span>
                  </p>
